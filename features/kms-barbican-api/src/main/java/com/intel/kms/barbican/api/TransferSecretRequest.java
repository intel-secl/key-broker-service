 ...
 * @author jbuhacoff
 */
public class TransferSecretRequest {
    @PathParam("id")
    ...
    @HeaderParam("Accept")
    public String accept; // content type from map of content types in GetSecretResponse, for example application/octet-stream
}
