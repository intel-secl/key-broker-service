...
public class SamlCertificateRepository implements DocumentRepository<Certificate, CertificateCollection, CertificateFilterCriteria, CertificateLocator> {
    ...
    private void configure(Configuration configuration) {
        ...
        this.keystoreFile = new File(configuration.get(com.intel.kms.saml.setup.SamlCertificates.SAML_KEYSTORE_FILE_PROPERTY, com.intel.kms.saml.setup.SamlCertificates.SAML_DEFAULT_KEYSTORE_FILE));
        this.keystoreType = configuration.get(com.intel.kms.saml.setup.SamlCertificates.SAML_KEYSTORE_TYPE_PROPERTY, com.intel.kms.saml.setup.SamlCertificates.SAML_DEFAULT_KEYSTORE_TYPE);
    ...
    public static class JXPathQuery<T> implements Filter<X509Certificate> {
        ...
        final private String jxpath;
        final private Filter<T> predicate;
